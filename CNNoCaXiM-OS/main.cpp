...
int main()
{
	...
	network->mountNode({ 1, 1 }, peNode4);
	network->mountNode({ 1, 2 }, peNode5);
	network->mountNode({ 1, 3 }, peNode6);
	network->mountNode({ 2, 1 }, peNode7);
	network->mountNode({ 2, 2 }, peNode8);
	network->mountNode({ 2, 3 }, peNode9);
